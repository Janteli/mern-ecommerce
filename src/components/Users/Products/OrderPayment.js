...
export default function OrderPayment() {
  ...
  const totalAmount = cartItems.reduce((accumulator, item) => {
    return accumulator + Number(item.totalPrice);
  }, 0);

  // console.log(totalAmount); // Output: 2582
  ...
  return (
    <>
      {orderErr && <ErrorMsg message={orderErr?.error} />}
