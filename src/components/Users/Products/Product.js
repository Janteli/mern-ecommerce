...
import { fetchSingProductAction } from "../../../redux/slice/products/productSlices";
import { addOrderToCart, getCartItemsFromLocalStorageAction } from "../../../redux/slice/cart/cartSlices";
...
export default function Product() {
  ...
  // console.log("id", id);
  useEffect(() => {
    // console.log("Dispatching fetch with id:", id);
      dispatch(fetchSingProductAction(id));
  }, [id]);
...
// const avg = totalRating/product.totalReviews
// console.log(avg);
  ...
  const addToCartHandler = () => {
    ...
    if(productExists){
      return Swal.fire({
        icon: "error",
        title: "Oops...!",
        text: 'This is product is already in cart',
      });
    }
