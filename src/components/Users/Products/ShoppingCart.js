...
import { changeOrderItemQty, getCartItemsFromLocalStorageAction, removeOrderItemQty } from "../../../redux/slice/cart/cartSlices";
import { fetchCouponAction } from "../../../redux/slice/coupon/couponSlice";
...
// price of the product - (price of product x discount/100)
  ...
  const removeOrderItemFromLocalStorageHandler
  = (productId, qty) =>{
    dispatch(removeOrderItemQty({
      productId
    }))
    dispatch( getCartItemsFromLocalStorageAction() )
  };
        ...
        <div className="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
          ...
          >
            ...
            <dl className="mt-6 space-y-4">
              ...
              {/* success */}
              {isAdded && <SuccessMsg message={`Congratulation you got ${coupon?.coupon?.discount}% discount`}/>}
